...
public class Repairs
{
    ...
    public ObservableList<OutstandingMain> getOutstanding() throws SQLException
    {
        ...
        //FOR PARTS
        SQL = "SELECT PARTID, DELIVERYDATE, RETURNDATE, COST, CENTRES.NAME FROM REPAIRPARTS, STOCKPARTS, CENTRES WHERE RETURNDATE >= Datetime('"+ LocalDate.now().toString() + "') AND REPAIRPARTS.SPCID = CENTRES.SPCID AND REPAIRPARTS.PARTID = STOCKPARTS.ID;";
        //System.out.println(SQL);
        rs = DBC.query(SQL);
        while(rs.next())
            {
    ...
    public ObservableList<OutstandingMain> getReturned() throws SQLException
    {
        ...
        //FOR PARTS
        SQL = "SELECT PARTID, DELIVERYDATE, RETURNDATE, COST, CENTRES.NAME FROM REPAIRPARTS, STOCKPARTS, CENTRES WHERE RETURNDATE < Datetime('"+ LocalDate.now().toString() + "') AND REPAIRPARTS.SPCID = CENTRES.SPCID AND REPAIRPARTS.SPCID = CENTRES.SPCID AND REPAIRPARTS.PARTID = STOCKPARTS.ID;";
        //System.out.println(SQL);
        rs = DBC.query(SQL);
        while(rs.next())
            {
